...
-- L'hash dell'admin corrisponde alla password di default '1111' (bcrypt, costo 10),
-- usata dall'autenticazione Admin dell'Iterazione 3 (accesso con sola password).
-- Al boot una migrazione idempotente reimposta comunque questo valore se l'hash
-- e' ancora un placeholder; la password si puo' poi cambiare via API o env.
INSERT INTO utente (username, password_hash, ruolo) VALUES
('admin', '$2b$10$jJEXhlsIZ5s5zA6dTEskSuF6ht2QbMP6gc/UAEWmU6tGQL0g5yKpW', 'admin'),
