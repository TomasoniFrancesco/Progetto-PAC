...
- Modifica quantita e note per porzione nella cassa
- Gestione scontistica
- Consultazione allergeni
- Pannello scorte nell'admin
- Integrazione stampa ESC/POS sulle stampanti di reparto
- Autenticazione e separazione ruoli
- Rendiconto di fine serata
